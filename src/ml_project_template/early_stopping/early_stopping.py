class EarlyStopping:
    ...
    def __call__(self, loss, model):
        ...
        if self.best_score is None:
            ...
            self.best_model_state = {k: v.detach().clone() for k, v in model.state_dict().items() if k in model_dict}
    ...
    def load_best_model(self, model):
        if self.best_model_state is None:
            raise ValueError("Calling this method before running early stopping is not permitted")
