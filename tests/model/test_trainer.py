...
def test_trainer_raises_error_if_no_model_provided(trainer_params):
...
def test_trainer_loads_correct_strategy(trainer_params):
...
def test_train_loop_updates_weights(trainer_params):
    trainer = Trainer(**trainer_params)
...
def test_test_loop_does_not_update_weights(trainer_params):
    trainer = Trainer(**trainer_params)
...
@patch("os.makedirs")
def test_save_as_onnx_calls_torch_export(mock_makedirs, mock_export, trainer_params):
    trainer = Trainer(**trainer_params)
